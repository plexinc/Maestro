...
class VegaDriver(
    ...
    // Vega/Fire TV renders a single dark system theme with no light-mode equivalent.
    override fun isDarkModeEnabled(): Boolean = true

    override fun setDarkMode(enabled: Boolean) {
        throw UnsupportedOperationException("setDarkMode is not supported on Vega")
    }
