...
object DeviceCreateUtil {
    ...
    fun getOrCreateAppleDevice(
        ...
        val deviceUUID = existingDeviceId ?: try {
            ...
            val closestInstalledRuntime = DeviceService.listAppleDevices().firstOrNull {
                it.deviceSpec.os.startsWith(deviceSpec.os)
            }?.deviceSpec?.os ?: deviceSpec.os

            //  Start the device
            DeviceService.createIosDevice(deviceName, deviceSpec.model, closestInstalledRuntime).toString()
